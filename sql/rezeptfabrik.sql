...
INSERT INTO `recipe_has_ingredient_has_unit_of_measurement` (`recipe_id`, `ingredient_id`, `unit_of_measurement_id`, `amount`) VALUES
(1, 1, 5, 5),
(1, 2, 7, 0.5),
(1, 3, 4, 320),
(1, 4, 7, 10),
...
INSERT INTO `user` (`id`, `firstname`, `lastname`, `user_name`, `email`, `password`) VALUES
(1, 'andi', 'andi', 'andi', 'andi@andi.com', '$2y$10$S/xA0FROTgfsgtyoEbIvluuqGLX25MJmwOiRH58TdRgoV/gpRqLWa'),
...
(4, 'peter', 'peter', 'peter', 'peter@peter.com', '$2y$10$3Zduf3VFa0hnyVW9YJ9bHOd9e0BzLQKQmR2qCeXb6SZ0wqJ85zIUi'),
(5, 'petra', 'petra', 'petra', 'petra@petra.com', '$2y$10$CXDTDX5FRGvX6LyPoQIVl.H/8n.6cAloUkSlquAQk23icmrD0YkdO');
...
INSERT INTO `user_has_role` (`user_id`, `role_name`) VALUES
(1, 'ADMIN'),
(1, 'USER'),
(2, 'ADMIN'),
(2, 'USER'),
